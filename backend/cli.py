...
def main():
    ...
    chg_p.add_argument("new_password")
    ...
    if args.command == "add-user":
        ok = user_store.create_user(args.username, args.password, args.display_name)
        if ok:
        ...
        ok = user_store.change_password(args.username, args.new_password)
        if ok:
