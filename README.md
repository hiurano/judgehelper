...
- **Отказоустойчивость LLM:** Каскадная цепочка резервных моделей (DeepSeek / Gemini / OpenAI) с автоматическим переключением при сбоях основной модели. Использование "окна памяти" для удержания ролей спикеров в длинных многочасовых аудио.
